...
public class GetAllChallengesStepDefs {
 ...
 /*   public void user_enters(String string) {
       ...
       //     response = given().spec(PetTesterUtilities.requestChallenger()).when().post(ConfigurationReader.get("url")+string);
        }else{
            response = given().spec(PetTesterUtilities.requestChallenger()).when().get(ConfigurationReader.get("url")+string);
        }
  ...
  /*  @Then("User should see all challenges")
    ...
    public void userEntersTheWithUrlAndIdNumber(String endingPoint, int idNumber) {
        response = given().spec(PetTesterUtilities.requestChallenger()).when().get(ConfigurationReader.get("url")+endingPoint+idNumber);
    ...
    public void userEntersTheWithUrlAndPOST(String endingPoint) {
        ...
        response= given().spec(PetTesterUtilities.requestChallenger())
    ...
    public void userShouldNOTSeeTheDeletedTODO() {
        response = given().spec(PetTesterUtilities.requestChallenger()).when().get(ConfigurationReader.get("url")+"todos");
